...
function M.config()
  ...
  wk.register {
    ...
    ["<leader>ff"]   = { "<cmd>lua require('telescope.builtin').find_files({ cwd = vim.fn.expand('%:p:h') })<cr>", "Find files" },
    ["<leader>ft"] = { "<cmd>lua require('telescope.builtin').live_grep({ cwd = vim.fn.expand('%:p:h') })<cr>", "Find Text" },
